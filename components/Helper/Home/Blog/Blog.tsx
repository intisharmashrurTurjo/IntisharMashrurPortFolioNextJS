...
const Blog = () => {
  return (
    <div className="pt-16 pb-16">
      <h1 className="text-center font-roboto-mono tracking-wider text-4xl md:text-4xl xl:text-5xl font-extrabold text-white">My Latest <span className="text-cyan-200 tracking-wider">Blogs</span> </h1>
